  ...
  return (
    <section className="py-14" data-aos="fade-up">
      <div className="container mx-auto">
        <div className="">
          <h1 className="border-b-2 border-[#0E9AC5] w-fit mx-auto text-3xl md:text-3xl font-medium">{t("Title")}</h1>
        ...
        <div id="services" className="lg:py-36 py-24">
          <h1 className="text-center text-3xl md:text-4xl font-semibold">{t("Title2")}</h1>
