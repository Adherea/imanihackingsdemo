...
function Page() {
  ...
  return (
    <section>
      ...
      <div className="px-9">
        <h1 className="text-center text-2xl md:text-3xl font-semibold py-10">{t("title")}</h1>

        <div className="max-w-7xl mx-auto flex md:flex-col-reverse lg:flex-row flex-col-reverse items-center justify-between">
          <div className="">
            <h1 className="py-5 text-xl md:text-2xl ">{t("session1")}</h1>
            <p className="max-w-xl md:text-xl">{t("desc1")}</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex md:flex-col-reverse py-14 lg:flex-row flex-col-reverse items-center justify-between">
          <div className="">
            <h1 className="py-5 text-xl md:text-2xl ">{t("session2")}</h1>
            <p className="max-w-xl md:text-xl">{t("desc2")}</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex md:flex-col-reverse lg:flex-row flex-col-reverse items-center justify-between">
          <div className="">
            <h1 className="py-5 text-xl md:text-2xl ">{t("session3")}</h1>
            <p className="max-w-xl md:text-xl">{t("desc3")}</p>
          </div>
      ...
      <div className="w-fit mx-auto py-20 px-8">
        ...
        <h1 className="py-24 text-center text-xl md:text-3xl font-semibold">{t("title3")}</h1>
